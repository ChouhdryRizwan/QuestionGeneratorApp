...
def generate_mcq(subject, number, level):
    ...
    # Assuming response.text is a string with questions formatted in a way we can split
    ...
    for question in questions:
        if question.strip():  # Check if the line is not empty
            ...
            formatted_questions.append("")  # Add a blank line for spacing
...
if st.button("Generate Questions"):
    if selected_subject and selected_level:
        ...
        st.write(questions.replace("\n", "\n\n"))  # Ensure double line breaks for spacing
    else:
